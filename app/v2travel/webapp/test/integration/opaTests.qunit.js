...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "nap/fe/v2travel/test/integration/FirstJourney",
    "nap/fe/v2travel/test/integration/TravelListJourney",
    "nap/fe/v2travel/test/integration/TravelObjectPageJourney",
    "nap/fe/v2travel/test/integration/BookingObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
